var options = {
    'datefile':  "datafile/object.children.json",
    'text': 'title',
    'size': 'count'
};

function renderObjectChildrenChart(){
    var m = [20, 120, 20, 120],
        w = 1280 - m[1] - m[3],
        h = 800 - m[0] - m[2],
        i = 0,
    ...
    var vis = d3.select("#objectChildrenChart").append("svg:svg")
        .attr("width", w + m[1] + m[3])
        .attr("height", h + m[0] + m[2])
        .append("svg:g")
        .attr("transform", "translate(" + m[3] + "," + m[0] + ")");

    d3.json("datafile/object.children.json", function(json) {
        root = json;
        root.x0 = h / 2;
        root.y0 = 0;
    ...
    function update(source) {
        ...
        nodes.forEach(function(d) { d.y = (d.depth * -180) + w; });
        ...
        var nodeEnter = node.enter().append("svg:g")
            ...
            .on("click", function(d) { Session.set('json_data', d.title); })
